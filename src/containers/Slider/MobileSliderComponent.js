...
const content = [
	{
		...
		image: 'https://i.imgur.com/u2nffSP.jpg',
	},
	{
		title:  <FormattedMessage id="page.landing.slider.title" />,
		description: <FormattedMessage id='page.landing.slider.description' />,
		button: <FormattedMessage id='page.header.navbar.signIn' />,
		image: 'https://i.imgur.com/yoptayL.jpg',
	},
	{
		title: <FormattedMessage id="page.landing.slider.title" />,
		description:<FormattedMessage id="page.landing.slider.description" />,
		button:<FormattedMessage id="page.header.navbar.signIn" />,
		image: 'https://i.imgur.com/IixfN81.jpg',
	},
	{
		title: <FormattedMessage id="page.landing.slider.title" />,
		description: <FormattedMessage id='page.landing.slider.description' />,
    ...
    render() {
        ...
        return (
				<div className="wrapper">
					...
					<Slider className="MobileSlider-wrapper" autoplay={6000} infinite={true}>
						{content.map((item, index) => (
							...
							>
								<div className="inner">
									...
									<div className={(item.image === "https://i.imgur.com/u2nffSP.jpg") ? 'SliderInvite' : (item.image === "https://i.imgur.com/yoptayL.jpg") ? 'SliderSinoMobile' : (item.image === "https://i.imgur.com/IixfN81.jpg") ? 'SliderSummit' : 'kk'} >
