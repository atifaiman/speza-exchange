...
class FiatWithdraw extends Component {
    ...
    render() {
        return (
            ...
            <br/>
            {((this.props.currency === 'myr') || (this.props.currency === 'krw') || (this.props.currency === 'vnd') || (this.props.currency === 'idr') || (this.props.currency === 'thb')) ? <AwepayWidthraw userid={this.props.userid} currency={this.props.currency} balance={this.props.balance} email={this.props.email}/> : null }
